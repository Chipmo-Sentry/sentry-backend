...
down_revision: str | None = "f7bd45a433a1"
...
def upgrade() -> None:
    ...
    op.add_column(
        "alerts",
        sa.Column("triggered_by", alert_trigger, server_default="manual_upload", nullable=False),
    )
    ...
    op.add_column(
        "cameras", sa.Column("risk_threshold", sa.Float(), nullable=False, server_default="70.0")
    )
